...
import homeCard1 from "../assets/home-card1.png";
...
const HomeCard = () => {
  return (
    <div className=" overflow-hidden rounded-[14px] relative cursor-pointer p-1  hover:border-4 hover:border-[--light-gray] transition-all ease-linear duration-150 group select-none">
      ...
      <img src={homeCard1} alt="" className="cursor-pointer rounded-md " />

      <div className="absolute top-0 left-0 h-full w-full p-4 500:px-5 500:py-6 1100:p-6">
