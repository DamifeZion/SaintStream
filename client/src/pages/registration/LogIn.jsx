...
const LogIn = () => {
  ...
  return (
    <div className="justify-center min-h-screen py-6 bg-[--black] 500:bg-[#08070A] 500:flex 500:flex-col 500:items-center">
      <div className="flex flex-col bg-[#0D0C0F] max-w-[480px] h-full 400:py-6 500:h-fit 500:rounded-3xl 500:w-5/6 500:border 500:border-[--dark-gray]">
