...
const ForgotPassword = () => {
  ...
  return (
    <div className="justify-center min-h-screen 500:bg-[#08070A] 500:flex 500:flex-col 500:items-center">
      <div className="flex flex-col bg-[#0D0C0F] 500:rounded-3xl 500:py-14 500:w-5/6 500:border 500:border-[--dark-gray] max-w-[480px]">
